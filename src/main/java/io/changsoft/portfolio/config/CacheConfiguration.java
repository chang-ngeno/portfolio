package io.changsoft.portfolio.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.changsoft.portfolio.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.changsoft.portfolio.repository.UserRepository.USERS_BY_EMAIL_CACHE);

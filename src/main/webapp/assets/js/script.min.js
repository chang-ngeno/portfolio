!(function (e, t) {
  ...
  var t = 'function' == typeof e,
    ...
    D = function (e, t, n) {
      ...
      for (a in t)
        (i = void 0 !== e[a]),
          i && 'object' == typeof t[a] && null !== t[a] && void 0 === t[a].nodeName
            ? c(t[a])
    ...
    b = function (e, t, n) {
      var i;
      a.createEvent
        ? ((i = a.createEvent('HTMLEvents')), i.initEvent(t, !0, !1), (i = D(i, n)), e.dispatchEvent(i))
        : a.createEventObject && ((i = a.createEventObject()), (i = D(i, n)), e.fireEvent('on' + t, i));
    },
    v = function (e) {
      return (
    ...
    x = function (e, t, n, a) {
      return (
        '<tr class="pika-row' + (n ? ' pick-whole-week' : '') + (a ? ' is-selected' : '') + '">' + (t ? e.reverse() : e).join('') + '</tr>'
      );
    },
    R = function (e) {
    ...
    S = function (e, t, n, a, i, s) {
      ...
      for (
        h =
          ...
          l.join('') +
          '</select></div>',
          u(c.yearRange) ? ((o = c.yearRange[0]), (r = c.yearRange[1] + 1)) : ((o = n - c.yearRange), (r = 1 + n + c.yearRange)),
          l = [];
        o < r && o <= c.maxYear;
        o++
      )
      ...
      return (
        ...
        t === e._o.numberOfMonths - 1 &&
          (m += '<button class="pika-next' + (y ? '' : ' is-disabled') + '" type="button">' + c.i18n.nextMonth + '</button>'),
        (m += '</div>')
      );
    },
    C = function (e, t, n) {
      return (
        '<table cellpadding="0" cellspacing="0" class="pika-table" role="grid" aria-labelledby="' + n + '">' + N(e) + R(t) + '</table>'
      );
    },
    I = function (o) {
      var r = this,
      ...
      (r._onMouseDown = function (e) {
            ...
            if (
              (l(t, 'is-disabled') ||
                (!l(t, 'pika-button') || l(t, 'is-empty') || l(t.parentNode, 'is-disabled')
                  ? l(t, 'pika-prev')
                    ? r.prevMonth()
                    : l(t, 'pika-next') && r.nextMonth()
                  : (r.setDate(
                      new Date(t.getAttribute('data-pika-year'), t.getAttribute('data-pika-month'), t.getAttribute('data-pika-day'))
                    ),
                    h.bound &&
                      i(function () {
                        r.hide(), h.blurFieldOnSelect && h.field && h.field.blur();
                      }, 100))),
              l(t, 'pika-select'))
            )
              r._c = !0;
        ...
        (r._onInputChange = function (n) {
          ...
          n.firedBy !== r &&
            (h.parse
              ? (a = h.parse(h.field.value, h.format))
              : t
              ? ((a = e(h.field.value, h.format, h.formatStrict)), (a = a && a.isValid() ? a.toDate() : null))
              : (a = new Date(Date.parse(h.field.value))),
            c(a) && r.setDate(a),
            r._v || r.show());
        }),
        ...
        (r._onClick = function (e) {
          ...
          var t = e.target || e.srcElement,
            a = t;
          if (t) {
            !n && l(t, 'pika-select') && (t.onchange || (t.setAttribute('onchange', 'return;'), s(t, 'change', r._onChange)));
            do {
              if (l(a, 'pika-single') || a === h.trigger) return;
            } while ((a = a.parentNode));
            r._v && t !== h.trigger && a !== h.trigger && r.hide();
          }
        }),
        ...
        h.keyboardInput && s(a, 'keydown', r._onKeyChange),
        h.field &&
          (h.container
          ...
          h.defaultDate ||
            (t && h.field.value
              ? (h.defaultDate = e(h.field.value, h.format).toDate())
              : (h.defaultDate = new Date(Date.parse(h.field.value))),
            (h.setDefaultDate = !0)));
      var d = h.defaultDate;
      c(d) ? (h.setDefaultDate ? r.setDate(d, !0) : r.gotoDate(d)) : r.gotoDate(new Date()),
        h.bound
          ? (this.hide(),
  ...
  return (
    (I.prototype = {
      ...
      setDate: function (e, t) {
        if (!e)
          return (
            (this._d = null), this._o.field && ((this._o.field.value = ''), b(this._o.field, 'change', { firedBy: this })), this.draw()
          );
      ...
      adjustCalendars: function () {
        ...
        for (var e = 1; e < this._o.numberOfMonths; e++)
          this.calendars[e] = v({ month: this.calendars[0].month + e, year: this.calendars[0].year });
        this.draw();
      },
      gotoToday: function () {
      ...
      draw: function (e) {
        if (this._v || e) {
          var t,
            ...
            r = n.maxMonth,
            l = '';
          this._y <= a && ((this._y = a), !isNaN(o) && this._m < o && (this._m = o)),
            this._y >= s && ((this._y = s), !isNaN(r) && this._m > r && (this._m = r)),
            (t =
              'pika-title-' +
              Math.random()
                .toString(36)
          ...
          for (var h = 0; h < n.numberOfMonths; h++)
            l +=
              ...
              S(this, h, this.calendars[h].year, this.calendars[h].month, this.calendars[0].year, t) +
      ...
      adjustPosition: function () {
        ...
        if (!this._o.container) {
          if (
            ...
            (c = e.getBoundingClientRect()), (l = c.left + window.pageXOffset), (u = c.bottom + window.pageYOffset);
          else for (l = t.offsetLeft, u = t.offsetTop + t.offsetHeight; (t = t.offsetParent); ) (l += t.offsetLeft), (u += t.offsetTop);
          ((this._o.reposition && l + n > s) || (this._o.position.indexOf('right') > -1 && l - n + e.offsetWidth > 0)) &&
            ((l = l - n + e.offsetWidth), (f = !1)),
            ((this._o.reposition && u + i > o + r) || (this._o.position.indexOf('top') > -1 && u - i - e.offsetHeight > 0)) &&
              ((u = u - i - e.offsetHeight), (g = !1)),
            (this.el.style.left = l + 'px'),
            (this.el.style.top = u + 'px'),
            h(this.el, f ? 'left-aligned' : 'right-aligned'),
            h(this.el, g ? 'bottom-aligned' : 'top-aligned'),
            d(this.el, f ? 'right-aligned' : 'left-aligned'),
            d(this.el, g ? 'top-aligned' : 'bottom-aligned');
        }
      },
      render: function (e, t, n) {
        ...
        for (var _ = !1, w = 0, R = 0; w < b; w++) {
          ...
          E && (w < o ? ((Y = D + Y), (O = h), (j = u)) : ((Y -= s), (O = d), (j = g)));
          var P = {
            day: Y,
            month: O,
            year: j,
          ...
          a.pickWholeWeek && S && (_ = !0),
            l.push(k(P)),
            7 == ++R &&
              (a.showWeekNumber && l.unshift(M(w - o, t, e)), r.push(x(l, a.isRTL, a.pickWholeWeek, _)), (l = []), (R = 0), (_ = !1));
        }
        return C(a, r, n);
      },
      isVisible: function () {

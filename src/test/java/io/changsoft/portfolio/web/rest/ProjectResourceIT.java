...
import io.changsoft.portfolio.domain.Project;
import io.changsoft.portfolio.repository.ProjectRepository;
import io.changsoft.portfolio.service.dto.ProjectDTO;
import io.changsoft.portfolio.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().title(DEFAULT_TITLE).slug(DEFAULT_SLUG);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().title(UPDATED_TITLE).slug(UPDATED_SLUG);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.title(UPDATED_TITLE).slug(UPDATED_SLUG);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.title(UPDATED_TITLE).slug(UPDATED_SLUG);
